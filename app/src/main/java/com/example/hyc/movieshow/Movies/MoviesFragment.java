...
public class MoviesFragment extends Fragment implements MoviesContract.View
{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(this.getContext(), LinearLayoutManager
            .VERTICAL, false));
    ...
    public void onResume()
    {
        ...
        ObservableTransformer<Object, Permission> permissionObservableTransformer = RxPermissions.getInstance(this.getActivity()).ensureEach(Manifest.permission.WRITE_EXTERNAL_STORAGE
            , Manifest.permission.READ_EXTERNAL_STORAGE
        );
        permissionObservableTransformer.apply(null);
